...
1. By getting the `des_pos_x` and `des_pos_y` parameters defined in the launch file `assignment1.launch`; ![first_part_parameters](https://imgur.com/a/LuGXehh)
2. By subscribing to the topic `reaching_goal/goal`. ![first_part_topic](https://imgur.com/a/mcaV2JA)
